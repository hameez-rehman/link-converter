  ...
  describe('Should convert product page to deeplink', () => {
    it('should convert to product page with city id to deeplink', () => {
      ...
      expect(deeplink).toBe(
        'washmen://?Page=Product&ContentId=1894501&CityId=994892-asda0-123-asdqw&ServiceName=clean-and-press',
      );
    });
    ...
    it('should convert to product page with cluster id to deeplink', () => {
      ...
      expect(deeplink).toBe(
        'washmen://?Page=Product&ContentId=1925865&ClusterId=439892&ServiceName=finery',
      );
    });
    ...
    it('should convert to product page with city and cluster id to deeplink', () => {
      ...
      expect(deeplink).toBe(
        'washmen://?Page=Product&ContentId=1925865&CityId=994892-asda0-123-asdqw&ClusterId=439892&ServiceName=finery',
      );
    });
  });
